LinkLuaModifier("modifier_mana_eater_passive", "heroes/warp_beast/warp_beast_mana_eater.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mana_eater_bonus_mana_count", "heroes/warp_beast/warp_beast_mana_eater.lua", LUA_MODIFIER_MOTION_NONE)
