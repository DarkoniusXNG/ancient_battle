...
LinkLuaModifier( "modifier_sohei_palm_of_life_movement", "heroes/sohei/sohei_palm_of_life.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
...
modifier_sohei_palm_of_life_movement = class({})
