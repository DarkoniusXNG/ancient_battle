...
LinkLuaModifier("modifier_sohei_momentum_strike_passive", "heroes/sohei/sohei_momentum_strike.lua", LUA_MODIFIER_MOTION_NONE)
...
modifier_sohei_momentum_strike_passive = class({})
...
function modifier_sohei_momentum_strike_passive:GetModifierPreAttack_CriticalStrike(event)
  ...
  if event.target:FindModifierByNameAndCaster("modifier_sohei_momentum_strike_knockback", parent) then
    ...
    return ability:GetSpecialValueFor("crit_damage") + bonus
  end
