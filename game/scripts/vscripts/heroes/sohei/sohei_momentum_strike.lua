LinkLuaModifier("modifier_sohei_momentum_strike_knockback", "heroes/sohei/sohei_momentum_strike.lua", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_sohei_momentum_strike_slow", "heroes/sohei/sohei_momentum_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sohei_momentum_strike_stun", "heroes/sohei/sohei_momentum_strike.lua", LUA_MODIFIER_MOTION_NONE)

sohei_momentum_strike = class({})
...
-- Knockback modifier
modifier_sohei_momentum_strike_knockback = class({})
...
if IsServer() then
  ...
  function modifier_sohei_momentum_strike_knockback:UpdateHorizontalMotion(parent, deltaTime)
    ...
    if GridNav:IsNearbyTree(tickOrigin, parent:GetPaddedCollisionRadius(), false) then
      self:ApplyStun(parent, caster, ability)
      GridNav:DestroyTreesAroundPoint(tickOrigin, parent:GetPaddedCollisionRadius(), false)
      self:Destroy()
      return
    end
...
-- Slow debuff
modifier_sohei_momentum_strike_slow = class({})
...
modifier_sohei_momentum_strike_slow.OnRefresh = modifier_sohei_momentum_strike_slow.OnCreated
...
-- Stun debuff
modifier_sohei_momentum_strike_stun = class({})
