...
LinkLuaModifier( "modifier_sohei_dash_free_turning", "heroes/sohei/sohei_dash.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sohei_dash_movement", "heroes/sohei/sohei_dash.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_sohei_dash_charges", "heroes/sohei/sohei_dash.lua", LUA_MODIFIER_MOTION_NONE )
