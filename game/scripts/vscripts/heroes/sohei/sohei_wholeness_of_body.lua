...
LinkLuaModifier("modifier_sohei_wholeness_of_body_buff", "heroes/sohei/sohei_wholeness_of_body.lua", LUA_MODIFIER_MOTION_NONE)
...
modifier_sohei_wholeness_of_body_buff = class({})
