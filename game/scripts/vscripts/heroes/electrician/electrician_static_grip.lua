...
LinkLuaModifier("modifier_special_bonus_electrician_static_grip_non_channel", "heroes/electrician/electrician_static_grip.lua", LUA_MODIFIER_MOTION_NONE)
...
modifier_special_bonus_electrician_static_grip_non_channel = class({})
