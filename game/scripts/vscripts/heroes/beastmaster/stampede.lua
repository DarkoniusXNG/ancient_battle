...
function Stampede( event )
	...
	-- Forward Vector
	local forwardVec = caster:GetForwardVector():Normalized()
	...
	local dummy = CreateUnitByName( "npc_dota_custom_dummy_unit", caster:GetAbsOrigin(), false, caster, caster, caster:GetTeamNumber() )
