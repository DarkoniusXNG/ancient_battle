...
LinkLuaModifier("modifier_pull_staff_passive", "items/pull_staff.lua", LUA_MODIFIER_MOTION_NONE)
...
function item_pull_staff:GetIntrinsicModifierName()
  return "modifier_pull_staff_passive"
end
...
function item_pull_staff:GetCustomCastErrorTarget(target)
  ...
  if target:HasModifier("modifier_faceless_void_chronosphere_freeze") then
    return "#custom_hud_error_pull_staff_chronosphere"
  end
  if target:HasModifier("modifier_legion_commander_duel") then
    return "#custom_hud_error_pull_staff_duel"
  end
  if target:HasModifier("modifier_batrider_flaming_lasso") then
    return "#custom_hud_error_pull_staff_lasso"
  end
...
modifier_pull_staff_active_buff = class({})
...
modifier_pull_staff_passive = class({})

function modifier_pull_staff_passive:IsHidden()
  return true
end

function modifier_pull_staff_passive:IsPurgable()
  return false
end

function modifier_pull_staff_passive:GetAttributes()
  return MODIFIER_ATTRIBUTE_MULTIPLE
end

function modifier_pull_staff_passive:DeclareFunctions()
  return {
...
function modifier_pull_staff_passive:GetModifierPreAttack_BonusDamage()
  return self:GetAbility():GetSpecialValueFor("bonus_damage")
end

function modifier_pull_staff_passive:GetModifierBonusStats_Strength()
  return self:GetAbility():GetSpecialValueFor("bonus_strength")
end

function modifier_pull_staff_passive:GetModifierBonusStats_Intellect()
  return self:GetAbility():GetSpecialValueFor("bonus_intellect")
end

function modifier_pull_staff_passive:GetModifierAttackSpeedBonus_Constant()
  return self:GetAbility():GetSpecialValueFor("bonus_attack_speed")
end

function modifier_pull_staff_passive:GetModifierConstantHealthRegen()
  return self:GetAbility():GetSpecialValueFor("bonus_health_regen")
end

function modifier_pull_staff_passive:GetModifierConstantManaRegen()
  return self:GetAbility():GetSpecialValueFor("bonus_mana_regen")
end

function modifier_pull_staff_passive:GetModifierPhysicalArmorBonus()
  return self:GetAbility():GetSpecialValueFor("bonus_armor")
end

if IsServer() then
  function modifier_pull_staff_passive:TriggerEchoStrike(target, slow)
    local parent = self:GetParent()
    local ability = self:GetAbility()
  ...
  function modifier_pull_staff_passive:OnAttackFail(event)
    local parent = self:GetParent()
  ...
  function modifier_pull_staff_passive:OnAttackLanded(event)
    local parent = self:GetParent()
    local attacker = event.attacker
    local target = event.target
