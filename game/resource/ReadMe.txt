1) Run generate_tooltips.bat to merge text files in folder tooltips_english and create tooltips_english.txt in resource folder.
2) generate_tooltips.bat will work only in that way only if he is inside that folder (tooltips_english)
